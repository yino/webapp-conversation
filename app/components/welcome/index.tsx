...
const Welcome = forwardRef(({
  ...
  const renderHeader = () => {
    return (
      <div className='absolute top-0 left-0 right-0 flex items-center justify-between border-b border-gray-100 mobile:h-12 tablet:h-16 px-8 bg-white hidden'>
  ...
  return (
    <div className='relative mobile:min-h-[30px] tablet:min-h-[64px]'>
